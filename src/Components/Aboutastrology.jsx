...
import "../styles/Aboutastrology.css";

const Aboutastrology = () => {
  return (
    <section className="about_astrology">
        <div className="container">
            <h2 className="heading_about_astrology">FAQ'S ABOUT ASTROLOGY</h2>
            <h3 className="subheading_about_astrology">Why Is Astrology So Accurate?</h3>
