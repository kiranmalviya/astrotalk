...
import "../styles/Whyastrology.css";
  ...
  return (
    <section className='why_astrology'>
        <div className="container">
            <h2 className="heading">WHY ASTROLOGY ?</h2>
            <h3 className="subheading">Astrology reveals the will of the God</h3>
            ...
            <div className="description-section">
                ...
                <div className="description">
                    ...
                    <p><strong>Stay Updated With Daily Horoscope Predictions & Zodiac Signs</strong></p>
                </div>
                ...
                <div className="description">
                    ...
                    <p><strong>Why Choose Our Astrology Experts?</strong></p>
                    <p>In a nutshell, Astrotalk and our experts could be your partner and guide when it comes to astrology. Be it a question on horoscope or numerology, tarot card reading or even connecting you with a foreign astrologer, we have practitioners to answer all your starry queries.</p>
